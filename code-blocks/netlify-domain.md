# Connecting Your Domain to Netlify [Edited By AI]
...
3. Add the following DNS records:
    - **A Record**: Point your domain to Netlify's IP address (e.g., 192.0.0.1)
    - **CNAME Record**: Point your subdomain (e.g., www) to your Netlify domain (e.g., your-site.netlify.app)
...
- If you want to switch hosting providers in the future, you may need to update your DNS
records again, which can lead to downtime if not done correctly.
- If you have a large number of subdomains, managing DNS records can become cumbersome compared to
using nameservers.
...
3. Replace the existing nameservers with Netlify's nameservers:
    - dns1.p34.nsone.net
    - dns2.p34.nsone.net
    - dns3.p34.nsone.net
    - dns4.p34.nsone.net
...
### Advantages
- Easier to set up for beginners, as you only need to change the nameservers without
worrying about individual DNS records.
- Netlify will automatically manage all DNS records for your domain, reducing the chances of misconfiguration.
- It's recommended for users who want a simple and hassle-free setup without needing to manage DNS records manually.
- If you have multiple subdomains, Netlify will handle the DNS management for all of them without requiring additional configuration from your side.
...
### Disadvantages
- You lose control over your DNS settings, as Netlify will manage all DNS records for your
domain.
- If you have other services (like email) associated with your domain, you may need to configure them through Netlify's DNS management, which can be less intuitive than managing them directly through your domain registrar.
...
- If you have a large number of subdomains, it may be more difficult to manage them through Netlify's DNS management compared to managing them directly through your domain registrar.
- If Netlify experiences any issues with their DNS management, it could potentially affect your website's availability, as you are relying on their infrastructure for DNS resolution.